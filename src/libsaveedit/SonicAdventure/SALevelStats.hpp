...
#ifndef __LIBSAVEEDIT_SONICADVENTURE_SALEVELSTATS_HPP__
#define __LIBSAVEEDIT_SONICADVENTURE_SALEVELSTATS_HPP__
...
#endif /* __LIBSAVEEDIT_SONICADVENTURE_SALEVELSTATS_HPP__ */
