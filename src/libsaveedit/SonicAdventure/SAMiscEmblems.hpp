...
#ifndef __LIBSAVEEDIT_SONICADVENTURE_SAMISCEMBLEMS_HPP__
#define __LIBSAVEEDIT_SONICADVENTURE_SAMISCEMBLEMS_HPP__
...
#endif /* __LIBSAVEEDIT_SONICADVENTURE_SAMISCEMBLEMS_HPP__ */
